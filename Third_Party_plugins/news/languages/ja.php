 ...
 */
	...
	$plugin_tx["news"]["Description"]="ブログ記事編集エリアの表示/非表示";
	$plugin_tx["news"]["Title"]="タイトル";
	$plugin_tx["news"]["Successfully deleted entry."]="削除しました";
	$plugin_tx["news"]["Successfully added entry."]="追加しました.";
	$plugin_tx["news"]["No categories found. Create a new one."]="カテゴリが１つもありません。カテゴリを作成してください.";
	...
	$plugin_tx["news"]["The category's name should not contain any whitespace or special characters."]="カテゴリの名前は、空白や特殊文字を含めることはできません。";
	...
	$plugin_tx["news"]["Short"]="ニュース(ブログﾓｰﾄﾞ時は要約）編集エリアの表示/非表示";
	$plugin_tx["news"]["Edit the selected entry:"]="記事の編集:";
	$plugin_tx["news"]["Publish the selected entry:"]="公開する:";
	$plugin_tx["news"]["Take out the selected entry:"]="公開する:";
	$plugin_tx["news"]["Delete the selected entry:"]="記事の削除:";
